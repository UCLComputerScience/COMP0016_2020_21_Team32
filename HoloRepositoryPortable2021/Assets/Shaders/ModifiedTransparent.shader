//This shader is the same as the "GLTFUtility/Standard Transparent (Metallic)" shader,
//but modified to write to the Zbuffer using a pass, which is uncommon
//for rendering transparent objects - but it ensures that all the segments of our organ are rendered
//in the correct order.
//It also uses the Standard shader as a fallback, since the Diffuse shader used in the original is a 
//legacy shader.

Shader "Custom/ModifiedTransparent" {
	Properties {
